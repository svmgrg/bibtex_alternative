...
\end{verbatim}
  ...
  The following snippet creates a reference section similar to the one at the end of this page:\footnote{Because of how \LaTeX\ manages hyperlinks, you will need two compilations for the references to appear properly.}
  \begin{minted}{latex}
