...
\newcommand{\fclrbx}[2]{\fcolorbox{#1!67!black}{#1!5!white}{#2}} %% https://tex.stackexchange.com/questions/446548/how-to-change-the-default-border-color-of-fbox
...
\DeclareMathOperator{\TTM}{\text{TTM}}
...
\newcommand{\shivam}[1]{\textcolor{red}{(SG: #1)}}
